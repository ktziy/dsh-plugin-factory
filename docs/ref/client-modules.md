# client-modules — subsystem reference (structured)

> the web plugin table: `dsh.client` declarations, `WebBootGraph` wire composition, the bundle route and index tap
