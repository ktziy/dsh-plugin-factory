# extensions — subsystem reference (structured)

> versioned dynamic Cordis Plugins and Packages, Host/Client activation, approval, runtime inspection, and lifecycle teardown
> Source: docs/subsystems/extensions.md
